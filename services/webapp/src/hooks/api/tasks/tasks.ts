...
export const getCreateTaskUrl = () => {
  ...
  return `http://mvp-ecs-alb-97805771.us-east-1.elb.amazonaws.com:3000/tasks/`
}
...
export const getGetTaskUrl = (id: string,) => {
  ...
  return `http://mvp-ecs-alb-97805771.us-east-1.elb.amazonaws.com:3000/tasks/${id}`
}
...
export const getCompleteTaskUrl = (id: string,) => {
  ...
  return `http://mvp-ecs-alb-97805771.us-east-1.elb.amazonaws.com:3000/tasks/${id}/complete`
}
